...
* [3 基于密度的聚类](#3)
<br>[3.1 DBSCAN](#3.1)
<br>[3.2 基于网格的聚类(CLIQUE)](#3.2)
<br>[3.3 DENCLUE](#3.3)
* [4 基于图的聚类](#4)
<br>[4.1 最小生成树聚类(MST)](#4.1)
<br>[4.2 OPOSSUM](#4.2)
<br>[4.3 Chameleon](#4.3)
<br>[4.4 SNN](#4.4)
...
<br>其中
<br>![](http://latex.codecogs.com/gif.latex?u_{ij})介于0,1之间;![](http://latex.codecogs.com/gif.latex?m\in [1,+\infty ))为控制算法模糊程度的参数.
...
\end{Bmatrix}^{-1}\ \ \ \ \ (5))
<br>看,我们得到了公式(5),即![](http://latex.codecogs.com/gif.latex?\lambda_{j})所需满足的条件.将公式(5)代回公式(4),我们得到:
