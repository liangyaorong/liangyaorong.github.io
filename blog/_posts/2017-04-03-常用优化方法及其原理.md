...
<br>**DFP算法的导出**
<br>
<br>**DFP算法核心在于寻找矩阵![](http://latex.codecogs.com/gif.latex?G_{k})去逼近海赛矩阵的逆矩阵![](http://latex.codecogs.com/gif.latex?H_{k}^{-1})**,即令其满足公式(2)
...
<br>**BFGS算法的导出**
<br>
<br>**BFGS算法核心在于寻找矩阵![](http://latex.codecogs.com/gif.latex?B_{k})去逼近海赛矩阵![](http://latex.codecogs.com/gif.latex?H_{k})**,即令其满足公式(1).
