...
<br>L-BFGS算法的思想是不储存![](http://latex.codecogs.com/gif.latex?G_{k})或![](http://latex.codecogs.com/gif.latex?B_{k}),而是用的时候再通过递推公式计算.因此需要储存的只有![](http://latex.codecogs.com/gif.latex? {y_{1}...y_{k}}), ![](http://latex.codecogs.com/gif.latex? {\delta _{1}...\delta _{k}})和![](http://latex.codecogs.com/gif.latex? G_{0}).
<br>甚至仅储存最新的前m个:
<br>![](http://latex.codecogs.com/gif.latex? {y_{k-m+1}...y_{k}})和
