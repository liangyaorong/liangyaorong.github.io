...
<br>
<br>FCM的目标函数是
<br>![](http://latex.codecogs.com/gif.latex?J=\sum_{i=1}^{n}\sum_{j=1}^{c} U_{i,j}^{m}d(x_{i},c_{j}))
<br>其中![](http://latex.codecogs.com/gif.latex?U_{i,j})介于0,1之间
<br>而且满足:
<br>![](http://latex.codecogs.com/gif.latex?J=\sum_{j=1}^{c} U_{i,j}=1)
